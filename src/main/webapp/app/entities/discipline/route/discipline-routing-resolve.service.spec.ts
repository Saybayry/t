...
import disciplineResolve from './discipline-routing-resolve.service';

describe('Discipline routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: DisciplineService;
  let resultDiscipline: IDiscipline | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IDiscipline returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        disciplineResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultDiscipline).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IDiscipline>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
